...
#ifndef SOAP_TYPE_ns1__handshakeSOAP_DEFINED
#define SOAP_TYPE_ns1__handshakeSOAP_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__handshakeSOAP(struct soap*, struct ns1__handshakeSOAP *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__handshakeSOAP(struct soap*, const struct ns1__handshakeSOAP *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__handshakeSOAP(struct soap*, const char*, int, const struct ns1__handshakeSOAP *, const char*);
SOAP_FMAC3 struct ns1__handshakeSOAP * SOAP_FMAC4 soap_in_ns1__handshakeSOAP(struct soap*, const char*, struct ns1__handshakeSOAP *, const char*);
SOAP_FMAC1 struct ns1__handshakeSOAP * SOAP_FMAC2 soap_instantiate_ns1__handshakeSOAP(struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__handshakeSOAP * soap_new_ns1__handshakeSOAP(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__handshakeSOAP(soap, n, NULL, NULL, NULL);
}

inline struct ns1__handshakeSOAP * soap_new_req_ns1__handshakeSOAP(
	struct soap *soap)
{
	struct ns1__handshakeSOAP *_p = soap_new_ns1__handshakeSOAP(soap);
	if (_p)
	{	soap_default_ns1__handshakeSOAP(soap, _p);
	}
	return _p;
}

inline struct ns1__handshakeSOAP * soap_new_set_ns1__handshakeSOAP(
	struct soap *soap)
{
	struct ns1__handshakeSOAP *_p = soap_new_ns1__handshakeSOAP(soap);
	if (_p)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__handshakeSOAP(struct soap*, const struct ns1__handshakeSOAP *, const char*, const char*);

inline int soap_write_ns1__handshakeSOAP(struct soap *soap, struct ns1__handshakeSOAP const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (soap_serialize_ns1__handshakeSOAP(soap, p), 0) || soap_put_ns1__handshakeSOAP(soap, p, "ns1:handshakeSOAP", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__handshakeSOAP(struct soap *soap, const char *URL, struct ns1__handshakeSOAP const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns1__handshakeSOAP(soap, p), 0) || soap_put_ns1__handshakeSOAP(soap, p, "ns1:handshakeSOAP", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns1__handshakeSOAP(struct soap *soap, const char *URL, struct ns1__handshakeSOAP const*p)
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns1__handshakeSOAP(soap, p), 0) || soap_put_ns1__handshakeSOAP(soap, p, "ns1:handshakeSOAP", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
SOAP_FMAC3 struct ns1__handshakeSOAP * SOAP_FMAC4 soap_get_ns1__handshakeSOAP(struct soap*, struct ns1__handshakeSOAP *, const char*, const char*);

inline int soap_read_ns1__handshakeSOAP(struct soap *soap, struct ns1__handshakeSOAP *p)
{
	if (p)
	{	soap_default_ns1__handshakeSOAP(soap, p);
		if (soap_begin_recv(soap) || soap_get_ns1__handshakeSOAP(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__handshakeSOAP(struct soap *soap, const char *URL, struct ns1__handshakeSOAP *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns1__handshakeSOAP(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns1__handshakeSOAP(struct soap *soap, struct ns1__handshakeSOAP *p)
{
	if (soap_read_ns1__handshakeSOAP(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif

#ifndef SOAP_TYPE_ns1__handshakeSOAPResponse_DEFINED
#define SOAP_TYPE_ns1__handshakeSOAPResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__handshakeSOAPResponse(struct soap*, struct ns1__handshakeSOAPResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__handshakeSOAPResponse(struct soap*, const struct ns1__handshakeSOAPResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__handshakeSOAPResponse(struct soap*, const char*, int, const struct ns1__handshakeSOAPResponse *, const char*);
SOAP_FMAC3 struct ns1__handshakeSOAPResponse * SOAP_FMAC4 soap_in_ns1__handshakeSOAPResponse(struct soap*, const char*, struct ns1__handshakeSOAPResponse *, const char*);
SOAP_FMAC1 struct ns1__handshakeSOAPResponse * SOAP_FMAC2 soap_instantiate_ns1__handshakeSOAPResponse(struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__handshakeSOAPResponse * soap_new_ns1__handshakeSOAPResponse(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__handshakeSOAPResponse(soap, n, NULL, NULL, NULL);
}

inline struct ns1__handshakeSOAPResponse * soap_new_req_ns1__handshakeSOAPResponse(
	struct soap *soap,
	bool return_)
{
	struct ns1__handshakeSOAPResponse *_p = soap_new_ns1__handshakeSOAPResponse(soap);
	if (_p)
	{	soap_default_ns1__handshakeSOAPResponse(soap, _p);
		_p->return_ = return_;
	}
	return _p;
}

inline struct ns1__handshakeSOAPResponse * soap_new_set_ns1__handshakeSOAPResponse(
	struct soap *soap,
	bool return_)
{
	struct ns1__handshakeSOAPResponse *_p = soap_new_ns1__handshakeSOAPResponse(soap);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__handshakeSOAPResponse(struct soap*, const struct ns1__handshakeSOAPResponse *, const char*, const char*);

inline int soap_write_ns1__handshakeSOAPResponse(struct soap *soap, struct ns1__handshakeSOAPResponse const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (soap_serialize_ns1__handshakeSOAPResponse(soap, p), 0) || soap_put_ns1__handshakeSOAPResponse(soap, p, "ns1:handshakeSOAPResponse", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__handshakeSOAPResponse(struct soap *soap, const char *URL, struct ns1__handshakeSOAPResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns1__handshakeSOAPResponse(soap, p), 0) || soap_put_ns1__handshakeSOAPResponse(soap, p, "ns1:handshakeSOAPResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns1__handshakeSOAPResponse(struct soap *soap, const char *URL, struct ns1__handshakeSOAPResponse const*p)
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns1__handshakeSOAPResponse(soap, p), 0) || soap_put_ns1__handshakeSOAPResponse(soap, p, "ns1:handshakeSOAPResponse", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
SOAP_FMAC3 struct ns1__handshakeSOAPResponse * SOAP_FMAC4 soap_get_ns1__handshakeSOAPResponse(struct soap*, struct ns1__handshakeSOAPResponse *, const char*, const char*);

inline int soap_read_ns1__handshakeSOAPResponse(struct soap *soap, struct ns1__handshakeSOAPResponse *p)
{
	if (p)
	{	soap_default_ns1__handshakeSOAPResponse(soap, p);
		if (soap_begin_recv(soap) || soap_get_ns1__handshakeSOAPResponse(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__handshakeSOAPResponse(struct soap *soap, const char *URL, struct ns1__handshakeSOAPResponse *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns1__handshakeSOAPResponse(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns1__handshakeSOAPResponse(struct soap *soap, struct ns1__handshakeSOAPResponse *p)
{
	if (soap_read_ns1__handshakeSOAPResponse(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
