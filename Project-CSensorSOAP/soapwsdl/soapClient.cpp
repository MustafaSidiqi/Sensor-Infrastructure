...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.8.41 2017-05-05 15:57:28 GMT")
...
{	struct ns1__requestConnectionSOAP soap_tmp_ns1__requestConnectionSOAP;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<struct ns1__requestConnectionSOAPResponse*>(&_param_1)) // NULL ref?
		return soap_closesock(soap);
...
{	struct ns1__getNonsenseSOAP soap_tmp_ns1__getNonsenseSOAP;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<struct ns1__getNonsenseSOAPResponse*>(&_param_1)) // NULL ref?
		return soap_closesock(soap);
...
{	struct ns1__getPublicKeySOAP soap_tmp_ns1__getPublicKeySOAP;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<struct ns1__getPublicKeySOAPResponse*>(&_param_1)) // NULL ref?
		return soap_closesock(soap);
...
{	struct ns1__sendCipherInonsenseSOAP soap_tmp_ns1__sendCipherInonsenseSOAP;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<struct ns1__sendCipherInonsenseSOAPResponse*>(&_param_1)) // NULL ref?
		return soap_closesock(soap);
...
{	struct ns1__sendLogHashCipherSOAP soap_tmp_ns1__sendLogHashCipherSOAP;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<struct ns1__sendLogHashCipherSOAPResponse*>(&_param_1)) // NULL ref?
		return soap_closesock(soap);
...
{	struct ns1__recieveOKSOAP soap_tmp_ns1__recieveOKSOAP;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<struct ns1__recieveOKSOAPResponse*>(&_param_1)) // NULL ref?
		return soap_closesock(soap);
