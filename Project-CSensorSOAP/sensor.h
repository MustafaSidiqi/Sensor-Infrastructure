...
@note HINTS:
 - Run soapcpp2 on sensor.h to generate the SOAP/XML processing logic.
...
/// Operation response struct "ns1__handshakeSOAPResponse" of operation "ns1__handshakeSOAP".
struct ns1__handshakeSOAPResponse
{
    bool                                return_;	///< Output parameter
};

/** Operation "ns1__handshakeSOAP" of service binding "DockImpSOAPPortBinding".
  ...
  - Addressing input action: "http://dockingsystem/DockIntSOAP/handshakeSOAPRequest"

  - Addressing output action: "http://dockingsystem/DockIntSOAP/handshakeSOAPResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_ns1__handshakeSOAP(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	handshakeSOAP SOAP
//gsoap ns1  service method-style:	handshakeSOAP rpc
//gsoap ns1  service method-encoding:	handshakeSOAP literal
//gsoap ns1  service method-input-action:	handshakeSOAP http://dockingsystem/DockIntSOAP/handshakeSOAPRequest
//gsoap ns1  service method-output-action:	handshakeSOAP http://dockingsystem/DockIntSOAP/handshakeSOAPResponse
int ns1__handshakeSOAP(
    struct ns1__handshakeSOAPResponse  &	///< Output response struct parameter
);
