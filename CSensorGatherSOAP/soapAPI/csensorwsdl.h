...
@note HINTS:
 - Run soapcpp2 on csensorwsdl.h to generate the SOAP/XML processing logic.
...
//  Forward declaration of class ns1__NoSuchAlgorithmException.
class ns1__NoSuchAlgorithmException;
...
///
/// class ns1__NoSuchAlgorithmException operations:
/// - ns1__NoSuchAlgorithmException* soap_new_ns1__NoSuchAlgorithmException(soap*) allocate and default initialize
/// - ns1__NoSuchAlgorithmException* soap_new_ns1__NoSuchAlgorithmException(soap*, int num) allocate array and default initialize values
/// - ns1__NoSuchAlgorithmException* soap_new_req_ns1__NoSuchAlgorithmException(soap*, ...) allocate, set required members
/// - ns1__NoSuchAlgorithmException* soap_new_set_ns1__NoSuchAlgorithmException(soap*, ...) allocate, set all public members
/// - ns1__NoSuchAlgorithmException::soap_default(soap*) default initialize members
/// - int soap_read_ns1__NoSuchAlgorithmException(soap*, ns1__NoSuchAlgorithmException*) deserialize from a stream
/// - int soap_write_ns1__NoSuchAlgorithmException(soap*, ns1__NoSuchAlgorithmException*) serialize to a stream
/// - ns1__NoSuchAlgorithmException* ns1__NoSuchAlgorithmException::soap_dup(soap*) returns deep copy of ns1__NoSuchAlgorithmException, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__NoSuchAlgorithmException::soap_del() deep deletes ns1__NoSuchAlgorithmException data members, use only after ns1__NoSuchAlgorithmException::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__NoSuchAlgorithmException
{ public:
...
{
    bool                                _return_;	///< Output parameter, _ wildcard name as per RPC parameterOrder
};
...
C++ proxy class (defined in soapDockImpSOAPPortBindingProxy.h generated with soapcpp2):
@code
  class DockImpSOAPPortBindingProxy;
@endcode
Important: use soapcpp2 option '-j' (or '-i') to generate improved and easy-to-use proxy classes;

C++ service class (defined in soapDockImpSOAPPortBindingService.h generated with soapcpp2):
@code
  class DockImpSOAPPortBindingService;
@endcode
...
int ns1__transferDataSOAP(
    std::string                         _arg0,	///< Input parameter, _ wildcard name as per RPC parameterOrder
    std::string                         _arg1,	///< Input parameter, _ wildcard name as per RPC parameterOrder
    std::string                         _arg2,	///< Input parameter, _ wildcard name as per RPC parameterOrder
...
//gsoap ns1  service method-fault:	getPublicKeySOAP ns1__NoSuchAlgorithmException_
...
//gsoap ns1  service method-fault:	recieveOKSOAP ns1__NoSuchAlgorithmException_
